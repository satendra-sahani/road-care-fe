      ...
      <div className="grid lg:grid-cols-[1.6fr_1fr] gap-4 items-stretch">
        ...
        <div className="relative rounded-2xl p-[22px] text-white overflow-hidden" style={{ background: `linear-gradient(135deg, ${DIST}, #F59E0B)` }}>
          ...
          <div className="flex flex-wrap gap-2.5 mt-4">
            <button onClick={() => toast('Withdrawals are processed each settlement cycle')} className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 rounded-xl px-4 py-2.5 font-bold text-[14px]"><ArrowUp className="h-[17px] w-[17px]" /> Withdraw</button>
